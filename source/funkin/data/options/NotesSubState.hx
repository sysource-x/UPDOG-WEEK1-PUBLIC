...
class NotesSubState extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		setOnScript('typeSelected', typeSelected);
		setOnScript('grpNumbers', grpNumbers);
		setOnScript('grpNotes', grpNotes);
		setOnScript('shaderArray', shaderArray);
		setOnScript('curValue', curValue);
		setOnScript('holdTime', holdTime);
		setOnScript('nextAccept', nextAccept);
		setOnScript('blackBG', blackBG);
		setOnScript('hsbText', hsbText);
		setOnScript('posX', posX);
		setOnScript('bg', bg);
