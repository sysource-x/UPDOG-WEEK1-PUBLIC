...
class PauseSubState extends MusicBeatSubstate
{
	...
	override function create()
	{
		try {
			...
			NativeAPI.showMessageBox("PauseSubState Error", "An error occurred while opening the pause menu:\n" + Std.string(e));
		}
	}
	...
	override function update(elapsed:Float)
	{
		try {
			...
			NativeAPI.showMessageBox("PauseSubState Error", "An error occurred during pause menu update:\n" + Std.string(e));
		}
	}
	...
	public function restartSong(noTrans:Bool = false)
	{
		try {
			...
			NativeAPI.showMessageBox("PauseSubState Error", "An error occurred while restarting the song:\n" + Std.string(e));
		}
	}
