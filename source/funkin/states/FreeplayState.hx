...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		try {
			...
			NativeAPI.showMessageBox("Freeplay Error", "An error occurred while opening Freeplay:\n" + Std.string(e));
		}
	}
	...
	function reloadWeekShit()
	{
		try {
			...
			NativeAPI.showMessageBox("Freeplay Error", "An error occurred while loading week data:\n" + Std.string(e));
		}
	}
	...
	function changeSong(by:Int)
	{
		try {
			...
			NativeAPI.showMessageBox("Freeplay Error", "An error occurred while changing the song:\n" + Std.string(e));
		}
	}
	...
	function startSong()
	{
		try {
			...
			NativeAPI.showMessageBox("Freeplay Error", "An error occurred while starting the song:\n" + Std.string(e));
		}
	}
	...
	override function update(elapsed:Float)
	{
		try {
			...
			NativeAPI.showMessageBox("Freeplay Error", "An error occurred during Freeplay update:\n" + Std.string(e));
		}
	}
