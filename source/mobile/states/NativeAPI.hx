...
/* -- How to use --
To use this API, you can call the static methods directly from anywhere in your code.
For example, to show a message box, you can do:

NativeAPI.showMessageBox("Title", "This is a message box.");

To set console colors, you can do:

NativeAPI.setConsoleColors(NativeAPI.RED, NativeAPI.BLACK);
