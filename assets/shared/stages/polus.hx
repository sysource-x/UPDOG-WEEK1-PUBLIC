...
function onLoad()
{
    try {
        ...
        NativeAPI.showMessageBox("polus.hx Error", "onLoad error:\n" + Std.string(e));
    }
}
...
function onCreatePost()
{
    try {
        ...
        NativeAPI.showMessageBox("polus.hx Error", "onCreatePost error:\n" + Std.string(e));
    }
}
...
function onUpdate(elapsed)
{
    try {
        ...
        NativeAPI.showMessageBox("polus.hx Error", "onUpdate error:\n" + Std.string(e));
    }
}
...
function revealVoters()
{
    try {
        ...
        NativeAPI.showMessageBox("polus.hx Error", "revealVoters error:\n" + Std.string(e));
    }
}
...
function refreshVoters()
{
    try {
        ...
        NativeAPI.showMessageBox("polus.hx Error", "refreshVoters error:\n" + Std.string(e));
    }
}
...
function onBeatHit()
{
    try {
        ...
        NativeAPI.showMessageBox("polus.hx Error", "onBeatHit error:\n" + Std.string(e));
    }
}
...
function onSongStart()
{
    try {
        ...
        NativeAPI.showMessageBox("polus.hx Error", "onSongStart error:\n" + Std.string(e));
    }
}
...
function onEvent(eventName, value1, value2)
{
    try {
        ...
        NativeAPI.showMessageBox("polus.hx Error", "onEvent error:\n" + Std.string(e));
    }
}
...
function buildMeltdownBG()
{
    try {
        ...
        NativeAPI.showMessageBox("polus.hx Error", "buildMeltdownBG error:\n" + Std.string(e));
    }
}
